...
SELECT RRNR_DAT_DVCD, RRNR_CTC_BZ_DVCD, SUBSTR(ARC_INPL_CD,1,5) AS PDC_CD,
...
SELECT B.RRNR_DAT_DVCD, B.RRNR_CTC_BZ_DVCD, SUBSTR(B.ARC_INPL_CD,1,5) AS PDC_CD, A.T02_RN_RINSC_CD,
...
SELECT RRNR_DAT_DVCD, RRNR_DMFR_DVCD, SUBSTR(ARC_INPL_CD,1,5) AS PDC_CD, NTNL_CTRY_CD, INRI_RN_KND_CD,
